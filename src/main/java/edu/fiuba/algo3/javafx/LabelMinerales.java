...
public class LabelMinerales extends Label implements Notificable {
    ...
    public LabelMinerales(Jugador jugador) {
        super("Minerales:\n" + jugador.invertirMineral().getCantidad());
    ...
    public void actualizar(Jugador jugadorDeTurno) {
        super.setText("Minerales\n" + this.jugador.invertirMineral().getCantidad());
    }
}
